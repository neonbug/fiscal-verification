 ...
 */
class ReferenceInvoice extends ReferenceInterface
{
    /**
    ...
    /**
     * Create new ReferenceInvoice instance
     *
    ...
    {
        return array(
            'ReferenceInvoiceIdentifier'    => array(
                'InvoiceNumber'      => $this->invoice_number,
                'BusinessPremiseID'  => $this->business_premise_id,
                'ElectronicDeviceID' => $this->electronic_device_id,
            ),
            'ReferenceInvoiceIssueDateTime' => date($this->getDateTimeFormat(), $this->issue_date_time),
        );
    }
}
